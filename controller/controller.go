...
func CallBackHandler(w http.ResponseWriter, r *http.Request) {
	...
	mpesaReceiptNumber := bd.(map[string]interface{})["Body"].(map[string]interface{})["stkCallback"].(map[string]interface{})["CallbackMetadata"].(map[string]interface{})["Item"].(map[string]interface{})["MpesaReceiptNumber"]
	// (map[string]map[string]interface{})["MpesaReceiptNumber"]
