...
func Routes() {
	...
	r.HandleFunc("/vehicle/{vehicleReg}", controllers.GetVehicleHandler).Methods("GET")
	...
	r.HandleFunc("/clearclampfee/{id}", controllers.ClearClampFee).Methods("POST")
	...
	r.HandleFunc("/clamprcb", controllers.ClampCallBackHandler).Methods("POST")
